...
"""305_mini_quest.py をゲーム抜きで通す。
    ...
    python tools/test_mini_quest.py
...
# ---- 2026-07-28 実機2回目: 達成したのに「撤退」になった件の回帰
...
# ---- 2026-07-28 実機3回目: 在庫が尽きた終盤にラスボス戦へ流れた件の回帰
...
# ---- 2026-07-28 実機4回目: 達成しても撤退になる（文面では2回外した）
print()
