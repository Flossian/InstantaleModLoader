...
新規作成したキャラクタが **経験値0のままレベル60** で始まる。セーブ側の実測と、
それをバグと判断した根拠は VERIFICATION.md §2.36 にある。要点だけ:
...
- レベル→体力上限の対応が、セーブから読んだ実測（VERIFICATION.md §2.36 の表）と
