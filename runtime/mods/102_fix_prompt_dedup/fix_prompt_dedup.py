...
現れている。本ビルドでの実測値:
    ...
    3 msgs, 11998 chars: system:8250:3e7de1f1cf, system:1898:59395e72f3, user:1850:...
    4 msgs, 20248 chars: system:8250:3e7de1f1cf, system:8250:3e7de1f1cf, system:1898:..., user:1850:...
                         この2つが完全に同じ内容で隣り合っている

要するに、同じ内容のメッセージが messages リストに2つ入っているだけ。
